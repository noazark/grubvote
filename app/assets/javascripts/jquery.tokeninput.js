    ...
    var input_box = $("<input type=\"text\"  autocomplete=\"off\" autocapitalize=\"off\">")
        ...
        .focus(function () {
            ...
            token_list
                ...
                .addClass($(input).data("settings").classes.focused);
        })
        .blur(function () {
            hide_dropdown();
        ...
        .keydown(function (event) {
            ...
            switch(event.keyCode) {
                ...
                case KEY.SPACE:
                  if($(input).data("settings").breakOnSpace) {
                    handleAddToken()
                    return false;
                  }
    ...
    function insert_token(item) {
        ...
        if(!readonly) {
          $("<span> " + $(input).data("settings").deleteText + "</span>")
              ...
              .appendTo($this_token.children('p'))
              .click(function () {
                  if (!$(input).data("settings").disabled) {
